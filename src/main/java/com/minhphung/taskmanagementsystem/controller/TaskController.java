...
public class TaskController {
    ...
    public ResponseEntity<List<TaskDto>> getAllTasksByEmployeeId(@PathVariable("id") Long employeeId){
        List<TaskDto> tasks = taskService.getAllTasksByEmployeeId(employeeId);
        return ResponseEntity.ok(tasks);
    }
